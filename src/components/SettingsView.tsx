              ...
              <>
                ...
                <div className="flex flex-col">
                  ...
                  {confirmAction === "delete" ? (
                    <div className="px-4 py-4"><ConfirmBox message={spaceActionTarget.include_in_personal ? `Delete "${spaceActionTarget.name}"? It's linked to Personal — those entries will disappear from Personal too. All data will be lost.` : `Delete "${spaceActionTarget.name}"? All data will be lost.`} confirmLabel="Yes, Delete" danger onConfirm={() => { onDeleteSpace(spaceActionTarget.id); setConfirmAction(null); setSpaceActionTarget(null); onToast(`"${spaceActionTarget.name}" deleted`); }} onCancel={() => setConfirmAction(null)} /></div>
